...
- 案头会自己翻页了：去浏览铺纸（默认流封面，凑得满两批 16 张时每 8 秒整批淡换）、今日报纸（日榜前 12 名每 12 秒换一组四格）、关注画师墙（有追踪时右栏新增，关注流画师头像随机 9–12 张每 8 秒整墙淡换）都是系统自动轮播，没有手动切换；切后台或滚出屏幕会暂停，系统开了「减弱动态效果」则静止。
